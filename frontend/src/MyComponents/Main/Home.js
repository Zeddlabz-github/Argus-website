    ...
    <div class="flex flex-wrap items-start">
      ...
      <div class="px-4 md:w-1/2 flex flex-col items-start">
        <div class="flex flex-col sm:flex-row items-center w-full">
            ...
            <h1 class="text-4xl title-font font-bold text-gray-900 mt-4 mb-4 lg:w-10/12">Introducing Argus Security Services</h1>
        </div>
        <p className="leading-relaxed text-l font-medium text-gray-2 mb-8">Argus Security ensures the team adherence to company rules and
        ...
        <div class="container px-2 py-2 mx-auto">
          <div class="w-full text-left">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="inline-block w-8 h-8 text-red-1 mb-4" viewBox="0 0 975.036 975.036">
            ...
            <p class="leading-relaxed text-l font-medium text-gray-3 bg-gray-200 p-3 rounded-lg shadow-lg">Success is not result of the amount of time we put in, instead its the quality of time we put in.</p>
            <div class="py-6 flex items-center">
              <img src={section4img} class="w-20 h-20 p-1 border border-red-1" alt=""/>
              <div class="mx-auto">
                <h2 class="text-gray-900 font-medium title-font tracking-wider text-sm">Name Here</h2>
...
<div class="bg-gray-200">
  ...
  <div class="w-1/2 mx-auto pb-10 flex">
      ...
      <svg class="w-12 -mr-10" xmlns="http://www.w3.org/2000/svg" width="85.04" height="85.003" viewBox="0 0 85.04 85.003">
      ...
      <div class="mx-auto py-4">
        <h2 class="leading-relaxed text-l font-medium text-gray-2">24 HOURS SERVICE AVAILABLE</h2>
        <p class="text-l title-font font-bold text-gray-900">Have any questions? Feel free to contact our office today at <span class="text-red-1">647.289.1070</span></p>
      </div>
    </div>
</div>
      ...
      <div class="md:w-1/2 p-4 flex flex-col items-start">
        ...
        <div class="flex items-center flex-wrap pb-4 mb-4 mt-auto w-full">
          ...
          <ul class="p-4">
            ...
            <li><span className="text-red-1">✓</span> Sometimes buys me Coffee</li>
            <li><span className="text-red-1">✓</span> Good Taste in Movies</li>
            <li><span className="text-red-1">✓</span> Good Guy Though </li>
          </ul>
          </div>
        </div> 
      </div>
