            ...
            <div>
                <div className="text-gray-600 body-font bg-no-repeat bg-cover bg-aboutbg">
                    <div className="container mx-auto flex px-5 py-40 items-center justify-center flex-col">
                        ...
                        <h1 className="title-font sm:text-6xl text-3xl mb-4 font-medium text-white">COMMUNICATIONS</h1>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap my-12">
                    <div className=" md:w-1/2 lg:w-2/3 flex flex-col items-start">
                        ...
                        <h2 className="text-4xl title-font font-bold text-gray-900 mt-8 mb-8">Highest Rated Industry Platform</h2>
                        <p className="leading-relaxed text-l font-medium text-gray-2 mb-8">When looking for a guard management solution, it’s important that the features it
                        ...
                        <h2 className="text-4xl title-font font-bold text-gray-900 mt-8 mb-8">Online Resource Center</h2>
                        <p className="leading-relaxed text-l font-medium text-gray-2 mb-8">Get full access to a comprehensive library of concise, informative how-to videos
                            and support articles to ensure customers get whatever they need at any time</p>

                        <h2 className="text-4xl title-font font-bold text-gray-900 mt-8 mb-8">“Show Me How”</h2>
                        <p className="leading-relaxed text-l font-medium text-gray-2 mb-8">The Issue Monitor has “Show Me How” buttons everywhere so system
