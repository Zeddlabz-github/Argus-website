                ...
                <div className="w-full md:w-8/12 bg-gray-1 ">
                    ...
                    <div className="text-center w-full">
                        ...
                        <div className="flex flex-col md:flex-row px-8">
                            <div className="w-full md:w-6/12 text-left bg-white shadow-xl rounded-xl p-8 m-3">
                            ...
                            <form className="bg-white shadow-xl rounded-xl p-4 w-full md:w-6/12 m-3" >
                                <input className="w-full mb-3 py-5 px-4 focus:outline-none focus:ring-1 ring-red-1" type="name" placeholder="Your Name" />
                                <input className="w-full mb-3 py-5 px-4 focus:outline-none focus:ring-1 ring-red-1" type="telephone" placeholder="Phone Number"/>
                                <textarea className="w-full h-56 mb-3 py-5 px-4 focus:outline-none focus:ring-1 ring-red-1" type="text" placeholder="Write Message"/>
